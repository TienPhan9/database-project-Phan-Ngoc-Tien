...
details,
cast(replace(minimum_trim, '.','') as numeric(13,0)) as beginning_price,
cast(replace(maximum_trim, '.','') as numeric(13,0)) as ending_price,
concat(minimum_trim, N' đồng', ' - ', maximum_trim, N' đồng') as price_range
from priceFix

--gom khoảng giá lại--một cột kiểu
